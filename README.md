# This project consists in run ta python file consistenly each week to extract open data of Unemployment Insurance Weekly Claim Data from https://oui.doleta.gov/unemploy/claims.asp
